export const CREDENTIALS_SECRET_KEY = "qwen.oauth.credentials";
...
export const QWEN_OAUTH_DEVICE_GRANT = "urn:ietf:params:oauth:grant-type:device_code";
export const QWEN_OATUH_REFRESH_GRANT = "refresh_token";

export const DEFAULT_BASE_URL = "https://portal.qwen.ai/v1/chat/completions";
